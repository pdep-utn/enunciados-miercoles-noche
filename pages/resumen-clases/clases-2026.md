...
- [este script](../clases/obj_clase2.md) y [una posible solución](https://github.com/pdep-utn/eg-docentes-wollok).
- [ejercicio de tom y jerry](https://github.com/pdep-mn-utn/tom-y-jerry)
...
Vamos a estar tomando el examen de lógico a partir de las 18 hs. en el aula 4 de Campus. 
...
Te dejamos una [posible solución](https://github.com/Juancete/parcial-logico-2025) junto con un breve análisis de diseño. 
...
### Bonus
- Les dejamos (esta página)[https://pbv.github.io/haskelite/site/index.html] donde pueden verificar cómo opera por detrás haskell reduciendo las expresiones. En el pié van a encontrar un campo donde dice **Enter an expression**. Ahí pueden probar por ejemplo expresiones como `foldl (+) 0 [1..5]` y luego `foldr (+) 0 [1..5]` para ver la diferencia.
...
- [Diapositivas de clase - Recursividad](https://drive.google.com/open?id=1GWq_FFNZOHzh-DxXDLVc_RgoWpxSFkBSh86_JkbCvqQ)
...
> **IMPORTANTE**: el miércoles 08/04 a las 19:00 hs vence el plazo para resolver la Kata de Funcional individual. Tienen que subir el código y los tests. **NO es obligatorio hacer TDD**. Te dejamos el [link al assignment](https://classroom.github.com/a/a0RObRKx)
...
- [Instalar el entorno Haskell](https://pdepre.ludat.io), si tenés problemas revisá la [página de troubleshooting](https://pdepre.ludat.io/guides/problemas/) o bien mandá un mail a la lista
...
- Grupo de la materia (pdep-mn@googlegroups.com), hay que actualizar **ahora mismo** tus datos en [esta planilla](https://docs.google.com/spreadsheets/d/1liT_85mXJKDwWw40Vu32Gx2QBZH3m56rdFaz_RZOWvU/edit?gid=839843558#gid=839843558)
- IMPORTANTE: Reglas de etiqueta para la comunicación
  ...
  - Cuando con sus grupos del TP manden mail a los tutores, **copien siempre a sus compañeros**, para que todos estén al tanto de las preguntas y las respuestas.
