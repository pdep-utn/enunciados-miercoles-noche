...
ghcup install hls 2.X.X.1   # instala una versión específica del componente Haskell Language Server (Pusimos X.X como ejemplo pero debe ser una versi´øn numérica específica)
